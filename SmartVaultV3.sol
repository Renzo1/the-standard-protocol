...
contract SmartVaultV3 is ISmartVault {
    ...
    // @Test Know issue: will revert if collateralRate is 0
    ...
    // @Test How can we make this function revert
    ...
    // @q What happens if I mint to address(this) Ans: closed
    function mint(address _to, uint256 _amount) external onlyOwner ifNotLiquidated {
        // @q what is the mint fee rate? mintFeeRate()
    ...
    function burn(uint256 _amount) external ifMinted(_amount) {
        ...
        // @audit if `msg.sender` burns all his EUROs token, where is the `fee` coming from?
        // I expect this to revert. If it doesn't then this function is minting tokens out of thin air
        // Maybe burn _amount - fee, and send the fee after burning
    ...
    function executeERC20SwapAndFee(ISwapRouter.ExactInputSingleParams memory _params, uint256 _swapFee) private {
        ...
        // Can this fail and cause loss of fund? Ans: No, All good!
        // Is there a return value to use to ensure transaction was successful? Ans: No
    ...
    function swap(bytes32 _inToken, bytes32 _outToken, uint256 _amount) external onlyOwner {
        ...
        // @audit no functionality for users  to set slippage protection.
        // allow users choose their slippage tolerance but ensure their position can be covered by the swap
